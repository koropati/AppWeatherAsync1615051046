...
export default class RamalanCuaca extends React.Component {
  ...
  try{
    ...
    let response = await fetch(
      'http://api.openweathermap.org/data/2.5/weather?q='+this.state.city+ '&appid=7cc62b49fe5d01dd68d03afa3ebceb0c&units=metric'
  ...
  render() {
    ...
    <View style={styles.containerMain}>
      ...
      <View style={styles.boxHeader}>
          <Text style={{ textAlign: 'center', padding: 45, fontSize: 25, color: '#E8F5E9'}} >Ramalan Cuaca</Text>
      </View>
      ...
      <View style={styles.boxFotter}>
          <Text style={{ textAlign: 'center', padding: 3, fontSize: 14}} >Copy Right DEWOK@App</Text>
      </View>
